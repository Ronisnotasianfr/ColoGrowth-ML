...
def build_abstract(metrics: pd.DataFrame, stats: dict) -> str:
    ...
    return (
        ...
        f"genes correlate with the label. With that caveat stated upfront, I compared four calibration strategies "
        f"(Platt Scaling, Isotonic Regression, QN+Platt, QN-only) "
